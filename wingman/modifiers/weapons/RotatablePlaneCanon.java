...
public class RotatablePlaneCanon extends AbstractRotatableWeapon {
    int strength;
    
    public RotatablePlaneCanon(){
        this(5,10);
    }
    
    public RotatablePlaneCanon(int reload){
        this(5,reload);
    }
    
    public RotatablePlaneCanon(int strength, int reload){
        super();
        this.reload = 30;
        this.strength = 50;
    }
