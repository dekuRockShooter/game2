...
public class PulseWeapon extends AbstractWeapon {
	public void fireWeapon(Ship theShip) {
		...
		bullets = new Bullet[] {
			new Bullet(location, new Point(3,1+speed.y), 2, new SimpleMotion(), theShip),
			new Bullet(location, new Point(-3,1+speed.y), 2, new SimpleMotion(), theShip),
			new Bullet(location, new Point(2,2+speed.y), 2, new SimpleMotion(), theShip),
			new Bullet(location, new Point(-2,2+speed.y), 2, new SimpleMotion(), theShip),
			new Bullet(location, new Point(1,3+speed.y), 2, new SimpleMotion(), theShip),
			new Bullet(location, new Point(-1,3+speed.y), 2, new SimpleMotion(), theShip),
		};
