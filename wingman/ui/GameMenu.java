...
public class GameMenu extends InterfaceObject {
	...
	public void applySelection(){
		...
		if(selection == 0){
			...
			PlayerShip player = new PlayerShip(new Point(240, size.height-50), new Point(6,6),GameWorld.sprites.get("player1"), controls, "Player 1");
			...
			players[0] = new PlayerShip(new Point(160, size.height-50), new Point(6,6),GameWorld.sprites.get("player1"), controls, "Player 1");
			controls = new int[] {KeyEvent.VK_LEFT,KeyEvent.VK_UP, KeyEvent.VK_RIGHT, KeyEvent.VK_DOWN, KeyEvent.VK_ENTER};
			players[1] = new PlayerShip(new Point(400, size.height-50), new Point(6,6),GameWorld.sprites.get("player2"), controls, "Player 2");
